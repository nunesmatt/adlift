...
*/
	...
	*/
	...
	int i,j,newpos, min;
	unsigned int oldpos=*la+10, curlen=*la;
	int *curleft=calloc(curlen, sizeof(int)),*oldleft=calloc(curlen, sizeof(int));
	int *current=calloc(curlen, sizeof(int)),*old=calloc(curlen, sizeof(int));
	int *o=calloc(curlen, sizeof(int));

	int *s=calloc(curlen, sizeof(int));
